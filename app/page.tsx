  ...
  <div>
    ...
    <p className="text-xs text-zinc-500">Asistente virtual basado en inteligencia artificial (no es una persona).</p>
        ...
        <div className="flex gap-2 border-t border-zinc-200 px-4 py-3">
          <input
            className="flex-1 rounded-md border border-zinc-300 px-3 py-2 text-sm text-zinc-900 focus:outline-none focus:ring-2 focus:ring-zinc-400"
          ...
          <button
            ...
            className="rounded-md bg-[#009639] px-4 py-2 text-sm font-medium text-white disabled:opacity-40"
          >
            Enviar
          </button>
        </div>
